...
namespace Owin.Security.Providers.FreeConferenceCall
{
    public class FreeConferenceCallAuthenticationMiddleware : AuthenticationMiddleware<FreeConferenceCallAuthenticationOptions>
    {
        ...
        public FreeConferenceCallAuthenticationMiddleware(OwinMiddleware next, IAppBuilder app, FreeConferenceCallAuthenticationOptions options)
            : base(next, options)
        {
        ...
        private HttpMessageHandler ResolveHttpMessageHandler(FreeConferenceCallAuthenticationOptions options)
        {
